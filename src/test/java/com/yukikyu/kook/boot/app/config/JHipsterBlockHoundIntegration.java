...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.yukikyu.kook.boot.app.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.yukikyu.kook.boot.app.security.DomainUserDetailsService", "createSpringSecurityUser");
